      ...
      {state.needsCity ? (
        <section className="caracol-city-layout" aria-labelledby="caracol-city-title">
          <div className="caracol-city-copy">
            ...
            <p className="section-lede">{state.you.alive ? 'O caracol está em Brasília. Quando você entrar no mapa, ele começa a andar.' : 'Suas moedas foram zeradas. Escolha qualquer cidade para voltar ao mapa.'}</p>
